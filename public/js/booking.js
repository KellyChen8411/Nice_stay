    ...
    if (trips.length === 0) {
      ...
      trips.forEach((trip, index) => {
        if (trip.is_refund === 0) {
          ...
          messageInfo.set(trip.booking_id, {owner_id:trip.landlord_id, owner_role:2,talker_id:trip.renter_id, talker_role:1, owner_name:trip.landloard_name, renter_name: trip.renter_name});
          if (
